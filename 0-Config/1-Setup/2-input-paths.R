...
app_engage_dir <- '/Users/maggiewang/Box/Woebot-Stanford Data Sharing'
...
# Path to app engagement data in treated group
app_engage_path <- file.path(app_engage_dir, 'NIDA SUD2 App Engagement Data - 2023-10-27_for Stanford.xlsx')
