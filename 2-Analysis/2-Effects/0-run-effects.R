print('1-assumptions.R')
source('2-Analysis/2-Effects/1-assumptions.R')

print('2a-between-group-primary.R')
source('2-Analysis/2-Effects/2a-between-group-primary.R')
